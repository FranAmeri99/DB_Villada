...
let connection = "localhost"; //Please, use your connection name
let database = "local" //Default is local;
let file_js = "/home/francisco/base de datos 2017/mongodb/primer-dataset.json";
...
let toImportContents = [
    { content: fs.readFileSync(file_js, "utf8"), collection: "restaurant", idPolicy: "overwrite_with_same_id" }
];
